...
public class MyDialog extends DialogFragment {
    ...
    private Dialog getUpdateClassDialog() {
        ...
        class_edt.setHint("Группа");
        subject_edt.setHint("Дисциплина");
        Button cancel = view.findViewById(R.id.cancel_btn);
        Button add = view.findViewById(R.id.add_btn);
        add.setText("Обновить");
    ...
    private Dialog getAddStudentDialog() {
        ...
        TextView title = view.findViewById(R.id.titleDialog);
        title.setText("Новый студент");

        EditText roll_edt = view.findViewById(R.id.est01);
        EditText name_edt = view.findViewById(R.id.edt02);

        roll_edt.setHint("Номер");
        name_edt.setHint("Имя");
        Button cancel = view.findViewById(R.id.cancel_btn);
        Button add = view.findViewById(R.id.add_btn);
